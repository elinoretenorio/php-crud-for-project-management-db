...
use ProjectManagement\Hours\{ HoursDto, HoursModel, HoursController };
...
class HoursControllerTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->service = $this->createMock("ProjectManagement\Hours\IHoursService");
        $this->request = $this->createMock("Psr\Http\Message\ServerRequestInterface");
        $this->stream = $this->createMock("Psr\Http\Message\StreamInterface");
        $this->controller = new HoursController(
            $this->service
        );
