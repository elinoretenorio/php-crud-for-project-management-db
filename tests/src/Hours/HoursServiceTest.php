...
use ProjectManagement\Hours\{ HoursDto, HoursModel, IHoursService, HoursService };
...
class HoursServiceTest extends TestCase
{
    ...
    {
        $this->repository = $this->createMock("ProjectManagement\Hours\IHoursRepository");
        $this->input = [
            "id" => 8238,
            "date" => "2021-10-16",
            "time" => 184.00,
            "work_completed" => "research",
            "task_id" => 486,
            "project_id" => 2456,
            "user_id" => 3350,
        ];
        ...
        $this->service = new HoursService($this->repository);
    }
