...
use ProjectManagement\Projects\{ ProjectsDto, ProjectsModel, ProjectsController };
...
class ProjectsControllerTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        $this->input = [
            ...
            "total_hours" => 932.50,
            "labor_costs" => 993.76,
            "material_cost" => 826.14,
        ];
        $this->dto = new ProjectsDto($this->input);
        $this->model = new ProjectsModel($this->dto);
        $this->service = $this->createMock("ProjectManagement\Projects\IProjectsService");
